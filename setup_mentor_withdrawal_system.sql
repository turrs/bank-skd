-- =====================================================
-- SETUP SISTEM WITHDRAWAL MENTOR
-- =====================================================
-- Jalankan script ini di Supabase SQL Editor
-- Script ini akan membuat semua tabel, functions, dan policies yang diperlukan
...
--
-- Langkah selanjutnya:
-- 1. Jalankan: SELECT calculate_mentor_earnings_from_sessions();
-- 2. Integrasikan komponen frontend ke aplikasi
-- 3. Test sistem withdrawal
