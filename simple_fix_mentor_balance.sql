-- =====================================================
-- SIMPLE FIX MENTOR BALANCE SYSTEM
-- =====================================================
...
-- 2. Create mentor_balances table (if not exists)
...
-- 3. Create mentor_withdrawals table (if not exists)
...
-- 4. Create mentor_earnings table (if not exists)
...
-- 9. Create function to update mentor balance
...
-- 10. Create function to calculate earnings from existing sessions
...
-- 12. Insert initial data for existing mentors
INSERT INTO public.mentor_balances (mentor_id, total_earnings, available_balance, total_withdrawn)
SELECT 
  u.id,
  0.00,
