-- =====================================================
-- SAFE FIX MENTOR BALANCE SYSTEM
-- =====================================================
...
-- 4. Create mentor_balances table (if not exists)
...
-- 5. Create mentor_withdrawals table (if not exists)
...
-- 6. Create mentor_earnings table (if not exists)
...
-- 11. Create function to update mentor balance
...
-- 12. Create function to calculate earnings from existing sessions
...
-- 14. Insert initial data for existing mentors
INSERT INTO public.mentor_balances (mentor_id, total_earnings, available_balance, total_withdrawn)
SELECT 
  u.id,
  0.00,
...
WHERE table_schema = 'public' AND routine_name LIKE '%mentor%';
